			...
			<div class="gtco-flex">
				<div class="feature feature-1 animate-box " data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Blog Personal</h3>
						<p>Membahas segala sesuatu yang ada di pikiran saya. </p>
				...
				<div class="feature feature-3 animate-box " data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Linkedin</h3>
						<p>Hanya untuk orang yang tahu saja, silakan di kunjungi. </p>
						<p><a href="http://linkedin.com/in/bdiarsa" class="btn btn-white btn-outline">Klik</a></p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box " data-animate-effect="fadeIn">
						...
						<h3>Designer</h3>
						<p>Mendesain beberapa jenis desain, tidak semua jenis, tapi beberapa jenis. </p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box " data-animate-effect="fadeIn">
						...
						<h3>Developer</h3>
						<p>Mengembangkan beberapa jenis software, tidak semua jenis, tapi beberapa jenis juga. </p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box " data-animate-effect="fadeIn">
						...
						<h3>Photographer</h3>
						<p>Kadang menjadi fotografer dadakan juga karena termasuk hobi. </p>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="feature-center animate-box " data-animate-effect="fadeIn">
				...
				<div class="col-md-12">
					<ul id="gtco-portfolio-list">
					    ...
					    <li class="one-third animate-box " data-animate-effect="fadeIn" style="background-image: url(images/img_4.jpg); "> 
							<a href="https://melajah.id" target="_blank" class="color-1">
								<div class="case-studies-summary">
									<span> Web App </span>
									<h2> Portal MELAJAH.id </h2>
								</div>
							</a>
						</li>
						...
						<li class="one-third animate-box " data-animate-effect="fadeIn" style="background-image: url(images/img_2.jpg); ">
							<a href="http://desalabasari.com" target="_blank" class="color-2">
								<div class="case-studies-summary">
									<span>Web Desa</span>
									<h2>Desa Laba Sari, Abang - Karangasem</h2>
								</div>
							</a>
						</li>
						...
						<li class="one-half animate-box " data-animate-effect="fadeIn" style="background-image: url(images/img_3.jpg); ">
							<a href="https://potensi.banglikab.go.id" target="_blank" class="color-3">
								<div class="case-studies-summary">
									<span>Web App</span>
									<h2>Pameran Pembangunan Pemkab Bangli</h2>
								</div>
							</a>
						</li>
						<li class="one-half animate-box " data-animate-effect="fadeIn" style="background-image: url(images/img_4.jpg); ">
